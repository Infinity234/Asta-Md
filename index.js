...
async function start(_0x733d1b) {
  ...
  const _0x314900 = [_0x418a10.join(_0x418a10.dirname(_0x2cd599), _0x733d1b), ...process.argv.slice(2)];
  const _0x4d851d = spawn(process.argv[0], _0x314900, {
    stdio: ["inherit", "inherit", "inherit", "ipc"]
  });
  _0x4d851d.on("message", _0x4a4026 => {
    console.log(_0x16d8a4.cyan("✔️RECEIVED " + _0x4a4026));
    switch (_0x4a4026) {
      case "reset":
        _0x4d851d.kill();
        isRunning = false;
